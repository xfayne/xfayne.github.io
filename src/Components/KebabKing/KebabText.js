...
export default function KebabText() {
    return (
        <div style = {{/* position: 'relative', zIndex: '1000' ,*/height:height}}>
            ...
            "Falafel King". <br/><br/>The game reached the top 10 of the games in Israel in the Android Play store for a while and had over <strong>50,000 downloads</strong>  there.</p>
            <br/><br/>
